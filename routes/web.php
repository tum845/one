...
Route::get('/category/create',['as'=>'categories.create', 'uses'=>'Admin\CategoryController@create']);
Route::post('/category',['as'=>'categories.store', 'uses'=>'Admin\CategoryController@store']);
